...
/**
 * This is the model class for table "formato_alumnos".
 *
 * @property int $id
 ...
 */
class FormatoAlumnos extends \yii\db\ActiveRecord
{
    ...
    public function uploadPath() {
        ...
        $path = \Yii::getAlias('@webroot')."/formatos/alumnos/";
        if(!file_exists($path)){
            mkdir($path,0777);
        }
        return $path;
    ...
    public function uploadFiles() {
        if(!is_null($this->file_formato)){
            ...
            $this->formato = "/formatos/alumnos/formato_".$this->nombre . "." .$this->file_formato->extension;
        }
