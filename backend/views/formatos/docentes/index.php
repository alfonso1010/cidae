...
<div class="box box-primary">
    ...
    <div class="box-body">
        <p align="right">
            <?= Html::a('Crear Formato Docentes', ['create-docente'], ['class' => 'btn btn-success']) ?>
        </p>
