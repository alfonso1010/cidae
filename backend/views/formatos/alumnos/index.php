                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function($model){
                            ...
                            return "<a target='_blank' href='".$ruta.$model->formato."'>".$model->nombre."</a>";
                        }
                    ],
                    'fecha_alta',
                    [
