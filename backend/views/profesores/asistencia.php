...
$this->registerJs('
    ...
    function guardarAsistencia(){
        ...
        $.ajax({
            ...
            async:false,
            url:"'.$url_guarda.'",
            data:{"id_grupo": id_grupo, "id_materia": id_materia,  "semestre": semestre, "asistencia":data_envio },
            success:function(data){ 
                try{
                    if(data.code == 200 ){
                        alertify.alert()
...
<div class="box box-primary">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-xs-12">
                <div class="col-sm-8">
                    <h4><b style="color: #092f87">Para tomar asisteencia seleccione Grupo y materia</b></h4><br>
                </div>
            </div>
        </div>
        <div class="row">
