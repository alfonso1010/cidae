        ...
        <div class="box-body">
            <div class="row">
                ...
                if(strlen($model->doc_acta_nacimiento) > 0){
                    $ruta = "https://controlescolar.universidadcidae.com.mx/docs_alumnos/".$model->id_alumno."/".$model->doc_acta_nacimiento;
                    echo '
                    <div class="col-sm-3">
                ...
                if(strlen($model->doc_curp) > 0){
                    $ruta = "https://controlescolar.universidadcidae.com.mx/docs_alumnos/".$model->id_alumno."/".$model->doc_curp;
                    echo '
                ...
                if(strlen($model->doc_ine) > 0){
                    $ruta = "https://controlescolar.universidadcidae.com.mx/docs_alumnos/".$model->id_alumno."/".$model->doc_ine;
                    echo '
                    <div class="col-sm-1"></div>
                    <div class="col-sm-3">
                ...
                if(strlen($model->doc_comp_domicilio) > 0){
                    $ruta = "https://controlescolar.universidadcidae.com.mx/docs_alumnos/".$model->id_alumno."/".$model->doc_comp_domicilio;
                    echo '
                    <div class="col-sm-1"></div>
                    <div class="col-sm-3">
                ...
                if(strlen($model->doc_certificado_bachillerato) > 0){
                    $ruta = "https://controlescolar.universidadcidae.com.mx/docs_alumnos/".$model->id_alumno."/".$model->doc_certificado_bachillerato;
                    echo '
                    <div class="col-sm-1"></div>
                    <div class="col-sm-3">
